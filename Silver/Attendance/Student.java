...
public class Student implements Attendance {
    ...
    public void DisplayAttendance() {
        ...
        System.out.printf("%10s %30s %20s %30s %15s", "SUBJECT", "WORKING DAYS", "DAYS MISSED", "LEAVE OF ABSENCE",
                "ATTENDANCE");
        System.out.println();
        System.out.println(
                "-------------------------------------------------------------------------------------------------------------------");
        for (int i = 0; i < numos; i++) {
            System.out.println();
            System.out.format("%10s %30d %20d %30d %15.2f", subjects[i], WorkingDays[i], AbsentDays[i], LOAoff[i],
                    totalAttendance[i]);
        }
        System.out.println();
    ...
    public void displayStatus() {
        ...
        for (int i = 0; i < numos; i++) {
            ...
            if (totalAttendance[i] < 70) {
                ...
                System.out.println("As of now you must hold " + count + " classes in " + subjects[i]
                        + "to fulfill attendance criteria");
            }
